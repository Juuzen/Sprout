...
public class TreeArcProgress extends View {
    private Paint paint;
    ...
    public TreeArcProgress(Context context) {
        this(context, null);
    }

    public TreeArcProgress(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TreeArcProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        default_text_size = TreeArcProgress.sp2px(getResources(), 18);
        min_size = (int) TreeArcProgress.dp2px(getResources(), 100);
        default_text_size = TreeArcProgress.sp2px(getResources(), 40);
        default_suffix_text_size = TreeArcProgress.sp2px(getResources(), 15);
        default_suffix_padding = TreeArcProgress.dp2px(getResources(), 4);
        default_suffix_text = "%";
        default_bottom_text_size = TreeArcProgress.sp2px(getResources(), 10);
        default_stroke_width = TreeArcProgress.dp2px(getResources(), 4);
